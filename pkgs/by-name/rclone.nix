...
buildGoModule (finalAttrs: {
  ...
  src = fetchFromGitHub {
    owner = "qbisi";
    repo = "rclone";
    tag = "v${finalAttrs.version}-mediastub";
    hash = "sha256-UOcD91UjMTqbjYPk5fraejX8KqIpYuD0L1tnWi7eeQg=";
  };

  vendorHash = "sha256-DmyedKyjynvhgQpxTXsrEnT/gbeocMYPvhg2GqJA0+8=";
